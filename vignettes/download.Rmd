---
title: "Explore and download sequencing databases: hows-to"
authors:
  Bastien CHASSAGNOL:
    href: https://github.com/bastienchassagnol/
  Savandara Besse:
    href: https://www.linkedin.com/in/savandara-besse/
  Frances FINOTELLO:
    href: https://omnideconv.org/
bibliography: references.bib
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Explore and download sequencing databases: hows-to}
...
**For a nice HTML + quarto presentation, with functional figure, lst and other float references; citations and nice call-out boxes, download locally self-embedded HTML file [download.html](https://github.com/bastienchassagnol/DrosophiliaDeconv/blob/main/inst/html/download.html).** 
